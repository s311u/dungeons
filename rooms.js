...
class Item { //items can include keys, potions, armor and other types of objects that will be useful later on in the game
    constructor(id, name, originalLocation, inInventory, type){
        this.id = id;
        this.name = name;
...
let items = [
    new Item(0, "Lock-picking kit", 0, 1, "item"), 
    new Item(1, "Health-restoring potion", 2, 0, "potion") //example jne jne
];
